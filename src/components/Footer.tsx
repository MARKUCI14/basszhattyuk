import { Box, Typography, Container, Link, SvgIcon } from '@mui/material';
  ...
  return (
    <Box component="footer" sx={{ py: 3, mt: 'auto', backgroundColor: '#f5f5f5', marginTop: 10 }}>
      <Container maxWidth="lg">
        ...
        >
          <Link
            href="https://www.instagram.com/basszhattyuk"
            target="_blank"
          ...
          <Link
            href="https://discord.gg/Ryt5MzE2dg"
            target="_blank"
            rel="noopener noreferrer"
            ...
            color="inherit"
          >
            <DiscordIcon sx={{ fontSize: 48, color: '#5865F2' }} />
          </Link>
        </Box>
